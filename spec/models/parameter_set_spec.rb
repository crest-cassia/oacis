...
describe ParameterSet do
  ...
  describe "result directory" do
    ...
    it "is created when a new item is added" do
      sim = FactoryGirl.create(:simulator, :parameter_sets_count => 0, parameter_set_queries_count:0)
  ...
  describe "#parameters_with_different" do
    ...
    before(:each) do
      ...
      sim = FactoryGirl.create(:simulator, :parameter_definitions => h, :parameter_sets_count => 0, parameter_set_queries_count:0)
      5.times do |n|
