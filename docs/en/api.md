...
If you would like to run a script from other directory, you have to set `BUNDLE_GEMFILE` environment variable.
Set `OACIS_ROOT` to point to the directory of OACIS, and run the script as follows.
