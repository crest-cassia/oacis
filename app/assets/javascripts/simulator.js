...
(() => {
  ...
  function draw_progress_overview(url) {
    ...
    const loading = OACIS.show_loading_spin_arc(arc_svg, arc_svg.attr("width"), arc_svg.attr("height"));
  ...
  OACIS.draw_color_map = draw_color_map;
  OACIS.show_loading_spin_arc = show_loading_spin_arc;
  OACIS.draw_progress_overview = draw_progress_overview;
  OACIS.validate_filter_value = validate_filter_value;
  OACIS.validate_filter_name = validate_filter_name;
})();
