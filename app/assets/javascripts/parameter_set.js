(() => {
  function create_parameter_sets_list(selector, default_length) {
    ...
    OACIS.setupRefreshTools(lengthDiv, function() { oPsTable.ajax.reload(null, false) });
  ...
  OACIS.create_parameter_sets_list = create_parameter_sets_list;
  OACIS.create_parameter_set_filters_list = create_parameter_set_filters_list;
})();
